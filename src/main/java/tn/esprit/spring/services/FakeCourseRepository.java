...
public class FakeCourseRepository implements ICourseRepository {
    private Map<Long, Course> courseDB = new HashMap<>();

    @Override
    public Optional<Course> findById(Long numCourse) {
        return Optional.ofNullable(courseDB.get(numCourse));
    }
    ...
    public void addCourse(Course course) {
        courseDB.put(course.getNumCourse(), course);
    }
